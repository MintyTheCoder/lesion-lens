# VTHacks Project — MS Lesion Detection: Revised Plan (Path B)
...
## Path B, confirmed: RF-DETR + Roboflow, reframed as lesion instance detection
...
### Option B — Build a lesion-pattern heuristic layer
